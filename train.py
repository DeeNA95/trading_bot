...
def create_environment(df, symbol, window_size, mode, leverage, max_position, initial_balance, 
                       risk_reward_ratio, stop_loss_percent, dynamic_leverage, 
                       use_risk_adjusted_rewards, trade_fee_percent):
...
def train_agent(
    ...
    logger.info(f"Final model evaluation on training data: Mean reward={train_reward:.2f}")
    ...
    if test_data_path:
        ...
        test_reward = agent.evaluate(num_episodes=10)
        logger.info(f"Final model evaluation on test data: Mean reward={test_reward:.2f}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", type=str, required=True, help="Path to training data file (CSV or Parquet)")
    parser.add_argument("--test_data", type=str, help="Path to test data file for evaluation (CSV or Parquet)")
    parser.add_argument("--symbol", type=str, default="BTCUSDT", help="Trading pair symbol")
    parser.add_argument("--window", type=int, default=24, help="Observation window size")
    parser.add_argument(
        "--model",
        type=str,
        default="lstm",
    ...
    parser.add_argument("--update_freq", type=int, default=2048, help="Steps between policy updates")
    parser.add_argument("--log_freq", type=int, default=50, help="Episodes between log updates")
    parser.add_argument("--save_freq", type=int, default=50, help="Episodes between model saves")
    parser.add_argument("--eval_freq", type=int, default=50, help="Episodes between evaluations")
    parser.add_argument(
        "--max_position",
        type=float,
        default=0.5,
    ...
    parser.add_argument("--stop_loss", type=float, default=0.01, help="Stop loss percentage")
    parser.add_argument(
        "--static_leverage",
        action="store_false",
