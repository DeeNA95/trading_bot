...
def test_agent_initialization():
    ...
    print(f"✓ Agent produced action: {action.shape}, log_prob: {log_prob.shape}, value: {value.shape}")
...
def test_memory_operations(agent):
    ...
    print(f"✓ Memory has sufficient samples after clearing: {agent.memory.is_sufficient()}")
...
def test_learning_process(agent):
    ...
    try:
        ...
        print("This is expected in some cases due to the complexity of the learning process.")
