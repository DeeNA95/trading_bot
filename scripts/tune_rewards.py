...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run reward function tuning experiments"
    )
...
def run_experiment(
    base_model_name, experiment_id, params, data_path, n_episodes, output_dir
):
...
def main():
    ...
    experiments_path = os.path.join(
        args.output_dir, f"{args.base_model_name}_{timestamp}_experiments.json"
    )
